"""
Script para popular o banco de dados com produtos de Comida e Bebida - VERSÃO COMPLETA
"""
from sqlalchemy.orm import Session
from database import SessionLocal, init_db, engine
from models import Base, User, Product, UserRole
from utils.auth import get_password_hash


def force_seed():
    """
    Remove tudo e recria o banco com TODOS os produtos da versão original
    """
