...
import { Coffee, Droplets, Beef, IceCream, Gamepad2, Trophy, ChevronLeft, ChevronRight, Sparkles } from "lucide-react";
...
const Products = () => {
  ...
  const allCategories: Category[] = [
    ...
    { name: "Bebidas Geladas", displayName: "Bebidas Geladas", icon: <Droplets className="h-6 w-6" />, color: "from-zinc-800 via-zinc-700 to-emerald-950" },
    ...
    { name: "Bebidas Quentes", displayName: "Bebidas Quentes", icon: <Coffee className="h-6 w-6" />, color: "from-zinc-800 via-zinc-700 to-yellow-950" },
    { name: "Combos", displayName: "Combos", icon: <Trophy className="h-6 w-6" />, color: "from-zinc-800 via-zinc-700 to-indigo-950" },
    { name: "Cafes", displayName: "Cafés", icon: <Coffee className="h-6 w-6" />, color: "from-zinc-800 via-zinc-700 to-amber-900" },
    { name: "Pizzas", displayName: "Pizzas", icon: <Coffee className="h-6 w-6" />, color: "from-zinc-800 via-zinc-700 to-red-950" },
    ...
    { name: "Snacks", displayName: "Snacks", icon: <Coffee className="h-6 w-6" />, color: "from-zinc-800 via-zinc-700 to-yellow-950" },
    { name: "Saladas", displayName: "Saladas", icon: <Coffee className="h-6 w-6" />, color: "from-zinc-800 via-zinc-700 to-green-950" },
